...
const TabFilters = () => {
  ...
  const renderXClear = () => {
    return (
      <span className="flex-shrink-0 w-4 h-4 rounded-full bg-secondary-500 text-white flex items-center justify-center ml-3 cursor-pointer">
        <svg
    ...
    return (
      <Popover className="relative">
        {({ open, close }) => (
          <>
            <Popover.Button
              className={`flex items-center justify-center px-4 py-2 text-sm rounded-full border border-secondary-500 bg-secondary-50 text-secondary-900 focus:outline-none `}
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 24 24"
  ...
  const renderTabMobileFilter = () => {
    return (
      <div className="flex-shrink-0">
        <div
          className={`flex flex-shrink-0 items-center justify-center px-4 py-2 text-sm rounded-full border border-secondary-500 bg-secondary-50 text-secondary-900 focus:outline-none cursor-pointer select-none`}
