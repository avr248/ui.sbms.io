...
const img1 = storagePath + "/images/collections/1.png";
const img2 = storagePath + "/images/collections/5.png";
const img3 = storagePath + "/images/collections/3.png";
const img4 = storagePath + "/images/collections/4.png";
