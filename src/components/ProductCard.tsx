...
const ProductCard: FC<ProductCardProps> = ({
    ...
    const sizesOnCard = data?.sizesOnCard || false;
    const buttonsOnCard = data?.buttonsOnCard || true;
                ...
                <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 items-end justify-between text-sm">
                        ...
                        <div className="flex">
                            <a
                                href={"/cart"}
                                className="font-medium text-secondary-6000 dark:text-secondary-500 "
                            >
                                View cart
                            </a>
                        </div>
    ...
    return (
        <>
            ...
            >
                <a href={"/product/" + id} className="absolute inset-0"></a>
                {/* <div className="relative flex-shrink-0 bg-slate-50 dark:bg-slate-300 rounded-3xl overflow-hidden z-1 group"> */}
                <div className="h-124 w-120 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100">
                    ...
                    {sizesOnCard &&
                        ...
                        sizes.length > 0 &&
                        renderSizeList()}
                    {buttonsOnCard && renderGroupButtons()}
                </div>
