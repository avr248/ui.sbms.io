...
const detail21JPG = storagePath + "/images/products/detail3-1.webp";
const detail22JPG = storagePath + "/images/products/detail3-2.webp";
const detail23JPG = storagePath + "/images/products/detail3-3.webp";
const detail24JPG = storagePath + "/images/products/detail3-4.webp";
					...
					<div className="hidden sm:flex flex-col space-y-4 ">
						<div className="space-y-2.5">
							<div className="flex justify-between text-slate-600 dark:text-slate-300">
								...
								<span>{`$${(PRICE * qualitySelected).toFixed(
									2
								)}`}</span>
							</div>
							<div className="flex justify-between text-slate-600 dark:text-slate-300">
			...
			<div className="listingSection__wrap !border-b-0 !pb-0">
				...
				<div className="prose prose-sm sm:prose dark:prose-invert sm:max-w-4xl">
					<p>
						...
						finely mortised in, makes this the strongest and most
						rigid canoe ever built. You cannot buy a canoe that will
						afford greater satisfaction.
					</p>
					<p>
						The St. Louis Meramec Canoe Company was founded by
						Alfred Wickett in 1922. Wickett had previously worked
						for the Old Town Canoe Co from 1900 to 1914.
						Manufacturing of the classic wooden canoes in Valley
					...
					<ul>
						...
						<li>
							Quality cotton grown without the use of herbicides
							or pesticides - GOTS certified
						</li>
